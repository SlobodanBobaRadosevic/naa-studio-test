      ...
      h = function (e, t, n) {
        ...
        (v.initialize = function () {
          ...
          (v.requireWidget = function (e) {
            "string" != typeof e &&
              v.logError("Widget Public ID required and should be a string", {
                pid: e,
              }),
          ...
          (v.getWidgetIdByElement = function (e) {
            return "div" === e.tagName.toLowerCase()
              ? v.getEappsClass(e).replace("elfsight-app-", "")
          ...
          (v.resetWidget = function (e) {
            ...
            v.getWidgetsElements().forEach(function (n) {
              v.getWidgetIdByElement(n) === e &&
                (delete b[e], n.parentNode.replaceChild(t(e), n));
            });
          }),
          ...
          (v.boot = function (e, t) {
            ...
            if (
              ...
              var r = new XMLHttpRequest(),
                a = v.getPlatformUrl();
              a += "/p/boot/";
              var s = o.stringify({ w: i.join(","), page: v.getPage() });
              r.open("get", a + "?" + s),
                (r.withCredentials = !0),
                (r.onload = function () {
                  var t = JSON.parse(r.response);
                  t.status ||
                    v.logError("Boot failed because " + t.reason, t.data),
        ...
        (t.initialize = function () {
            ...
            if (i) {
              ...
              var a = {
                  ...
                  displayFreeLinkRemove:
                    !!r.preferences.display_free_link_remove,
                  freeLinkURL: r.preferences.free_link_url,
              ...
              (r.settings = [r.settings, a, s].reduce(function (e, t) {
                ...
                e.initWidget(n, r.settings, r),
                r.isOwner &&
                  setTimeout(function () {
                    t.initToolbar(n, r);
                  }, 500);
            } else o.push({ element: n, config: r, initialized: !1 });
          }),
          (t.initToolbar = function (e, t) {
            ...
            var i = document.implementation.createHTMLDocument(),
              ...
              r = "".concat(n, "/apps/").concat(t.app, "/pricing"),
              a = "".concat(n, "/widget/").concat(t.id),
              s = function (e, n) {
